...
public class CommentAPICompareController {
    ...
    public String search(Invocation inv,@Param("beginDate") String beginDateStr, @Param("endDate") String endDateStr,
            @Param("cDate1") String cDate1, @Param("cDate2") String cDate2,@Param("queryJiekou") String queryJiekou,@Param("queryParentJiekou") String queryParentJiekou,
            @Param("queryZhibiao") String queryZhibiao){
		...
		inv.addModel("queryJiekou",queryJiekou);
		inv.addModel("queryParentJiekou",queryParentJiekou);
		inv.addModel("queryZhibiao",queryZhibiao);
