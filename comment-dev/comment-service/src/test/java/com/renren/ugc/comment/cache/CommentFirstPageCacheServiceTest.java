...
/**
 * 标注:{@link CommentFirstPageCacheServiceTest} 评论中心cache测试类
 * 
 ...
 * 
 */
public class CommentFirstPageCacheServiceTest {

    CommentCacheService service = CommentFirstPageCacheService.getInstance();

    long entryId = 361463488;
    ...
    int limit = CommentFirstPageCacheService.PAGE_COUNT;

    int borderCommentId = 0;
