...
public class CreateLinkedCommentResponse implements org.apache.thrift.TBase<CreateLinkedCommentResponse, CreateLinkedCommentResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CreateLinkedCommentResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new CreateLinkedCommentResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CreateLinkedCommentResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CreateLinkedCommentResponse.class, metaDataMap);
  }

  public CreateLinkedCommentResponse() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public CreateLinkedCommentResponse(CreateLinkedCommentResponse other) {
  ...
  public CreateLinkedCommentResponse deepCopy() {
    return new CreateLinkedCommentResponse(this);
  }
   ...
   * 新创建的评论
   */
  public CreateLinkedCommentResponse setComment(com.renren.ugc.comment.xoa2.Comment comment) {
   ...
   * 响应信息
   */
  public CreateLinkedCommentResponse setBaseRep(com.renren.xoa2.BaseResponse baseRep) {
   ...
   * 被评论的“实体”
   */
  public CreateLinkedCommentResponse setEntry(com.renren.ugc.comment.xoa2.Entry entry) {
    this.entry = entry;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CreateLinkedCommentResponse)
      return this.equals((CreateLinkedCommentResponse)that);
    return false;
  }

  public boolean equals(CreateLinkedCommentResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CreateLinkedCommentResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CreateLinkedCommentResponse typedOther = (CreateLinkedCommentResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CreateLinkedCommentResponse(");
    boolean first = true;
  ...
  private static class CreateLinkedCommentResponseStandardSchemeFactory implements SchemeFactory {
    public CreateLinkedCommentResponseStandardScheme getScheme() {
      return new CreateLinkedCommentResponseStandardScheme();
    }
  }

  private static class CreateLinkedCommentResponseStandardScheme extends StandardScheme<CreateLinkedCommentResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CreateLinkedCommentResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CreateLinkedCommentResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CreateLinkedCommentResponseTupleSchemeFactory implements SchemeFactory {
    public CreateLinkedCommentResponseTupleScheme getScheme() {
      return new CreateLinkedCommentResponseTupleScheme();
    }
  }

  private static class CreateLinkedCommentResponseTupleScheme extends TupleScheme<CreateLinkedCommentResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CreateLinkedCommentResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CreateLinkedCommentResponse struct) throws org.apache.thrift.TException {
