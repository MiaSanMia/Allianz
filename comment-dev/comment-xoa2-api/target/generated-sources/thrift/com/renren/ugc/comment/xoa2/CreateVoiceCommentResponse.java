...
public class CreateVoiceCommentResponse implements org.apache.thrift.TBase<CreateVoiceCommentResponse, CreateVoiceCommentResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CreateVoiceCommentResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new CreateVoiceCommentResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CreateVoiceCommentResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CreateVoiceCommentResponse.class, metaDataMap);
  }

  public CreateVoiceCommentResponse() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public CreateVoiceCommentResponse(CreateVoiceCommentResponse other) {
  ...
  public CreateVoiceCommentResponse deepCopy() {
    return new CreateVoiceCommentResponse(this);
  }
   ...
   * 新创建的评论
   */
  public CreateVoiceCommentResponse setComment(com.renren.ugc.comment.xoa2.Comment comment) {
   ...
   * 响应信息
   */
  public CreateVoiceCommentResponse setBaseRep(com.renren.xoa2.BaseResponse baseRep) {
   ...
   * 被评论的“实体”
   */
  public CreateVoiceCommentResponse setEntry(com.renren.ugc.comment.xoa2.Entry entry) {
    this.entry = entry;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CreateVoiceCommentResponse)
      return this.equals((CreateVoiceCommentResponse)that);
    return false;
  }

  public boolean equals(CreateVoiceCommentResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CreateVoiceCommentResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CreateVoiceCommentResponse typedOther = (CreateVoiceCommentResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CreateVoiceCommentResponse(");
    boolean first = true;
  ...
  private static class CreateVoiceCommentResponseStandardSchemeFactory implements SchemeFactory {
    public CreateVoiceCommentResponseStandardScheme getScheme() {
      return new CreateVoiceCommentResponseStandardScheme();
    }
  }

  private static class CreateVoiceCommentResponseStandardScheme extends StandardScheme<CreateVoiceCommentResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CreateVoiceCommentResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CreateVoiceCommentResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CreateVoiceCommentResponseTupleSchemeFactory implements SchemeFactory {
    public CreateVoiceCommentResponseTupleScheme getScheme() {
      return new CreateVoiceCommentResponseTupleScheme();
    }
  }

  private static class CreateVoiceCommentResponseTupleScheme extends TupleScheme<CreateVoiceCommentResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CreateVoiceCommentResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CreateVoiceCommentResponse struct) throws org.apache.thrift.TException {
