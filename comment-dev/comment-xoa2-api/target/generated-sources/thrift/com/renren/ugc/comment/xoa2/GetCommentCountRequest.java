...
public class GetCommentCountRequest implements org.apache.thrift.TBase<GetCommentCountRequest, GetCommentCountRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetCommentCountRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetCommentCountRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetCommentCountRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetCommentCountRequest.class, metaDataMap);
  }
   ...
   */
  public GetCommentCountRequest(GetCommentCountRequest other) {
  ...
  public GetCommentCountRequest deepCopy() {
    return new GetCommentCountRequest(this);
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public GetCommentCountRequest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 来校验权限
   */
  public GetCommentCountRequest setActorId(int actorId) {
   ...
   * 被评论实体Id
   */
  public GetCommentCountRequest setEntryId(long entryId) {
    this.entryId = entryId;
    setEntryIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体所有者Id
   */
  public GetCommentCountRequest setEntryOwnerId(int entryOwnerId) {
    this.entryOwnerId = entryOwnerId;
    setEntryOwnerIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetCommentCountRequest)
      return this.equals((GetCommentCountRequest)that);
    return false;
  }

  public boolean equals(GetCommentCountRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetCommentCountRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetCommentCountRequest typedOther = (GetCommentCountRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetCommentCountRequest(");
    boolean first = true;
  ...
  private static class GetCommentCountRequestStandardSchemeFactory implements SchemeFactory {
    public GetCommentCountRequestStandardScheme getScheme() {
      return new GetCommentCountRequestStandardScheme();
    }
  }

  private static class GetCommentCountRequestStandardScheme extends StandardScheme<GetCommentCountRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetCommentCountRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetCommentCountRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetCommentCountRequestTupleSchemeFactory implements SchemeFactory {
    public GetCommentCountRequestTupleScheme getScheme() {
      return new GetCommentCountRequestTupleScheme();
    }
  }

  private static class GetCommentCountRequestTupleScheme extends TupleScheme<GetCommentCountRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetCommentCountRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetCommentCountRequest struct) throws org.apache.thrift.TException {
