...
public class GetCommentListRequest implements org.apache.thrift.TBase<GetCommentListRequest, GetCommentListRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetCommentListRequest");
  ...
  private static final org.apache.thrift.protocol.TField BORDER_COMMENT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("borderCommentId", org.apache.thrift.protocol.TType.I64, (short)9);
  ...
  private static final org.apache.thrift.protocol.TField INCLUDE_GLOBAL_COMMENT_FIELD_DESC = new org.apache.thrift.protocol.TField("includeGlobalComment", org.apache.thrift.protocol.TType.BOOL, (short)11);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new GetCommentListRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetCommentListRequestTupleSchemeFactory());
  }
   ...
   */
  public boolean includeGlobalComment; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 建议采用此值来进行分页。
     */
    BORDER_COMMENT_ID((short)9, "borderCommentId"),
    /**
     * 额外的参数，用于传入业务相关的参数
     */
     ...
     * 是否要获取全站评论，目前只对share有效
     */
    INCLUDE_GLOBAL_COMMENT((short)11, "includeGlobalComment");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 8: // DESC
          return DESC;
        case 9: // BORDER_COMMENT_ID
          return BORDER_COMMENT_ID;
        case 10: // PARAMS
          return PARAMS;
        case 11: // INCLUDE_GLOBAL_COMMENT
          return INCLUDE_GLOBAL_COMMENT;
        default:
          return null;
      }
    }
  ...
  private static final int __BORDERCOMMENTID_ISSET_ID = 7;
  private static final int __INCLUDEGLOBALCOMMENT_ISSET_ID = 8;
  private BitSet __isset_bit_vector = new BitSet(9);
  private _Fields optionals[] = {_Fields.ACTOR_ID,_Fields.OFFSET,_Fields.LIMIT,_Fields.PAGE_NUM,_Fields.DESC,_Fields.BORDER_COMMENT_ID,_Fields.PARAMS,_Fields.INCLUDE_GLOBAL_COMMENT};
  ...
  static {
    ...
    tmpMap.put(_Fields.PARAMS, new org.apache.thrift.meta_data.FieldMetaData("params", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            ...
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.INCLUDE_GLOBAL_COMMENT, new org.apache.thrift.meta_data.FieldMetaData("includeGlobalComment", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetCommentListRequest.class, metaDataMap);
  }
   ...
   */
  public GetCommentListRequest(GetCommentListRequest other) {
    ...
    this.includeGlobalComment = other.includeGlobalComment;
  }

  public GetCommentListRequest deepCopy() {
    return new GetCommentListRequest(this);
  }
  ...
  public void clear() {
    ...
    this.params = null;
    setIncludeGlobalCommentIsSet(false);
    this.includeGlobalComment = false;
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public GetCommentListRequest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 来校验权限
   */
  public GetCommentListRequest setActorId(int actorId) {
   ...
   * 被评论实体Id
   */
  public GetCommentListRequest setEntryId(long entryId) {
    this.entryId = entryId;
    setEntryIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体所有者Id
   */
  public GetCommentListRequest setEntryOwnerId(int entryOwnerId) {
    this.entryOwnerId = entryOwnerId;
    setEntryOwnerIdIsSet(true);
    return this;
  }
   ...
   * 搜索开始的位置
   */
  public GetCommentListRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
   ...
   * 返回结果的最大个数
   */
  public GetCommentListRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
   ...
   * 当前的分页数, 从1开始计数
   */
  public GetCommentListRequest setPageNum(int pageNum) {
   ...
   * 返回结果排序，true为从最新到旧返回结果
   */
  public GetCommentListRequest setDesc(boolean desc) {
    this.desc = desc;
    setDescIsSet(true);
    return this;
  }
   ...
   * 建议采用此值来进行分页。
   */
  public GetCommentListRequest setBorderCommentId(long borderCommentId) {
   ...
   * 额外的参数，用于传入业务相关的参数
   */
  public GetCommentListRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
   ...
   * 是否要获取全站评论，目前只对share有效
   */
  public boolean isIncludeGlobalComment() {
    return this.includeGlobalComment;
  }

  /**
   * 是否要获取全站评论，目前只对share有效
   */
  public GetCommentListRequest setIncludeGlobalComment(boolean includeGlobalComment) {
    this.includeGlobalComment = includeGlobalComment;
    setIncludeGlobalCommentIsSet(true);
    return this;
  }

  public void unsetIncludeGlobalComment() {
    __isset_bit_vector.clear(__INCLUDEGLOBALCOMMENT_ISSET_ID);
  }

  /** Returns true if field includeGlobalComment is set (has been assigned a value) and false otherwise */
  public boolean isSetIncludeGlobalComment() {
    return __isset_bit_vector.get(__INCLUDEGLOBALCOMMENT_ISSET_ID);
  }

  public void setIncludeGlobalCommentIsSet(boolean value) {
    __isset_bit_vector.set(__INCLUDEGLOBALCOMMENT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INCLUDE_GLOBAL_COMMENT:
      if (value == null) {
        unsetIncludeGlobalComment();
      } else {
        setIncludeGlobalComment((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case INCLUDE_GLOBAL_COMMENT:
      return Boolean.valueOf(isIncludeGlobalComment());
  ...
  public boolean isSet(_Fields field) {
    ...
    case PARAMS:
      return isSetParams();
    case INCLUDE_GLOBAL_COMMENT:
      return isSetIncludeGlobalComment();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetCommentListRequest)
      return this.equals((GetCommentListRequest)that);
    return false;
  }

  public boolean equals(GetCommentListRequest that) {
    if (that == null)
      return false;
    ...
    boolean this_present_includeGlobalComment = true && this.isSetIncludeGlobalComment();
    boolean that_present_includeGlobalComment = true && that.isSetIncludeGlobalComment();
    if (this_present_includeGlobalComment || that_present_includeGlobalComment) {
      if (!(this_present_includeGlobalComment && that_present_includeGlobalComment))
        return false;
      if (this.includeGlobalComment != that.includeGlobalComment)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_includeGlobalComment = true && (isSetIncludeGlobalComment());
    builder.append(present_includeGlobalComment);
    if (present_includeGlobalComment)
      builder.append(includeGlobalComment);

    return builder.toHashCode();
  }

  public int compareTo(GetCommentListRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetCommentListRequest typedOther = (GetCommentListRequest)other;
    ...
    lastComparison = Boolean.valueOf(isSetIncludeGlobalComment()).compareTo(typedOther.isSetIncludeGlobalComment());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludeGlobalComment()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.includeGlobalComment, typedOther.includeGlobalComment);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetIncludeGlobalComment()) {
      if (!first) sb.append(", ");
      sb.append("includeGlobalComment:");
      sb.append(this.includeGlobalComment);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class GetCommentListRequestStandardSchemeFactory implements SchemeFactory {
    public GetCommentListRequestStandardScheme getScheme() {
      return new GetCommentListRequestStandardScheme();
    }
  }

  private static class GetCommentListRequestStandardScheme extends StandardScheme<GetCommentListRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetCommentListRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 11: // INCLUDE_GLOBAL_COMMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.includeGlobalComment = iprot.readBool();
              struct.setIncludeGlobalCommentIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetCommentListRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetIncludeGlobalComment()) {
        oprot.writeFieldBegin(INCLUDE_GLOBAL_COMMENT_FIELD_DESC);
        oprot.writeBool(struct.includeGlobalComment);
        oprot.writeFieldEnd();
      }
  ...
  private static class GetCommentListRequestTupleSchemeFactory implements SchemeFactory {
    public GetCommentListRequestTupleScheme getScheme() {
      return new GetCommentListRequestTupleScheme();
    }
  }

  private static class GetCommentListRequestTupleScheme extends TupleScheme<GetCommentListRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetCommentListRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetCommentListRequest struct) throws org.apache.thrift.TException {
