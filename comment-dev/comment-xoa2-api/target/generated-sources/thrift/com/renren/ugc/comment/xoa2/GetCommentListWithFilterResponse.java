...
public class GetCommentListWithFilterResponse implements org.apache.thrift.TBase<GetCommentListWithFilterResponse, GetCommentListWithFilterResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetCommentListWithFilterResponse");
  ...
  private static final org.apache.thrift.protocol.TField ENTRY_FIELD_DESC = new org.apache.thrift.protocol.TField("entry", org.apache.thrift.protocol.TType.STRUCT, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new GetCommentListWithFilterResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetCommentListWithFilterResponseTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.COMMENT_LIST,_Fields.BASE_REP,_Fields.MORE,_Fields.TOTAL_COUNT,_Fields.ENTRY};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetCommentListWithFilterResponse.class, metaDataMap);
  }

  public GetCommentListWithFilterResponse() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public GetCommentListWithFilterResponse(GetCommentListWithFilterResponse other) {
  ...
  public GetCommentListWithFilterResponse deepCopy() {
    return new GetCommentListWithFilterResponse(this);
  }
   ...
   * 获取的评论的列表
   */
  public GetCommentListWithFilterResponse setCommentList(List<com.renren.ugc.comment.xoa2.Comment> commentList) {
   ...
   * 响应信息
   */
  public GetCommentListWithFilterResponse setBaseRep(com.renren.xoa2.BaseResponse baseRep) {
   ...
   * 是否有更多的评论
   */
  public GetCommentListWithFilterResponse setMore(boolean more) {
    this.more = more;
    setMoreIsSet(true);
    return this;
  }
   ...
   * 属于当前Entry的评论的总数
   */
  public GetCommentListWithFilterResponse setTotalCount(long totalCount) {
   ...
   * 被评论的“实体”
   */
  public GetCommentListWithFilterResponse setEntry(com.renren.ugc.comment.xoa2.Entry entry) {
    this.entry = entry;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetCommentListWithFilterResponse)
      return this.equals((GetCommentListWithFilterResponse)that);
    return false;
  }

  public boolean equals(GetCommentListWithFilterResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetCommentListWithFilterResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetCommentListWithFilterResponse typedOther = (GetCommentListWithFilterResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetCommentListWithFilterResponse(");
    boolean first = true;
  ...
  private static class GetCommentListWithFilterResponseStandardSchemeFactory implements SchemeFactory {
    public GetCommentListWithFilterResponseStandardScheme getScheme() {
      return new GetCommentListWithFilterResponseStandardScheme();
    }
  }

  private static class GetCommentListWithFilterResponseStandardScheme extends StandardScheme<GetCommentListWithFilterResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetCommentListWithFilterResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commentList = new ArrayList<com.renren.ugc.comment.xoa2.Comment>(_list390.size);
                for (int _i391 = 0; _i391 < _list390.size; ++_i391)
                {
                  com.renren.ugc.comment.xoa2.Comment _elem392; // required
                  _elem392 = new com.renren.ugc.comment.xoa2.Comment();
                  _elem392.read(iprot);
                  struct.commentList.add(_elem392);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetCommentListWithFilterResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.commentList != null) {
        if (struct.isSetCommentList()) {
          oprot.writeFieldBegin(COMMENT_LIST_FIELD_DESC);
          {
            ...
            for (com.renren.ugc.comment.xoa2.Comment _iter393 : struct.commentList)
            {
  ...
  private static class GetCommentListWithFilterResponseTupleSchemeFactory implements SchemeFactory {
    public GetCommentListWithFilterResponseTupleScheme getScheme() {
      return new GetCommentListWithFilterResponseTupleScheme();
    }
  }

  private static class GetCommentListWithFilterResponseTupleScheme extends TupleScheme<GetCommentListWithFilterResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetCommentListWithFilterResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCommentList()) {
        {
          ...
          for (com.renren.ugc.comment.xoa2.Comment _iter394 : struct.commentList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetCommentListWithFilterResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.commentList = new ArrayList<com.renren.ugc.comment.xoa2.Comment>(_list395.size);
          for (int _i396 = 0; _i396 < _list395.size; ++_i396)
          {
            com.renren.ugc.comment.xoa2.Comment _elem397; // required
            _elem397 = new com.renren.ugc.comment.xoa2.Comment();
            _elem397.read(iprot);
            struct.commentList.add(_elem397);
          }
        }
        struct.setCommentListIsSet(true);
      }
