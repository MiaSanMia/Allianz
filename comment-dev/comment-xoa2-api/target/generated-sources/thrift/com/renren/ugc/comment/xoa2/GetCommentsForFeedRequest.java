...
public class GetCommentsForFeedRequest implements org.apache.thrift.TBase<GetCommentsForFeedRequest, GetCommentsForFeedRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetCommentsForFeedRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetCommentsForFeedRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetCommentsForFeedRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetCommentsForFeedRequest.class, metaDataMap);
  }

  public GetCommentsForFeedRequest() {
  }
   ...
   */
  public GetCommentsForFeedRequest(GetCommentsForFeedRequest other) {
  ...
  public GetCommentsForFeedRequest deepCopy() {
    return new GetCommentsForFeedRequest(this);
  }
   ...
   * 批量取首尾评论的参数
   */
  public GetCommentsForFeedRequest setInfos(List<FeedCommentInfo> infos) {
    this.infos = infos;
    return this;
  }
   ...
   * 来校验权限
   */
  public GetCommentsForFeedRequest setActorId(int actorId) {
  ...
  public GetCommentsForFeedRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetCommentsForFeedRequest)
      return this.equals((GetCommentsForFeedRequest)that);
    return false;
  }

  public boolean equals(GetCommentsForFeedRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetCommentsForFeedRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetCommentsForFeedRequest typedOther = (GetCommentsForFeedRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetCommentsForFeedRequest(");
    boolean first = true;
  ...
  private static class GetCommentsForFeedRequestStandardSchemeFactory implements SchemeFactory {
    public GetCommentsForFeedRequestStandardScheme getScheme() {
      return new GetCommentsForFeedRequestStandardScheme();
    }
  }

  private static class GetCommentsForFeedRequestStandardScheme extends StandardScheme<GetCommentsForFeedRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetCommentsForFeedRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.infos = new ArrayList<FeedCommentInfo>(_list268.size);
                for (int _i269 = 0; _i269 < _list268.size; ++_i269)
                {
                  FeedCommentInfo _elem270; // required
                  _elem270 = new FeedCommentInfo();
                  _elem270.read(iprot);
                  struct.infos.add(_elem270);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.params = new HashMap<String,String>(2*_map271.size);
                for (int _i272 = 0; _i272 < _map271.size; ++_i272)
                {
                  String _key273; // required
                  String _val274; // required
                  _key273 = iprot.readString();
                  _val274 = iprot.readString();
                  struct.params.put(_key273, _val274);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetCommentsForFeedRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.infos != null) {
        oprot.writeFieldBegin(INFOS_FIELD_DESC);
        {
          ...
          for (FeedCommentInfo _iter275 : struct.infos)
          {
      ...
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter276 : struct.params.entrySet())
            {
  ...
  private static class GetCommentsForFeedRequestTupleSchemeFactory implements SchemeFactory {
    public GetCommentsForFeedRequestTupleScheme getScheme() {
      return new GetCommentsForFeedRequestTupleScheme();
    }
  }

  private static class GetCommentsForFeedRequestTupleScheme extends TupleScheme<GetCommentsForFeedRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetCommentsForFeedRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetInfos()) {
        {
          ...
          for (FeedCommentInfo _iter277 : struct.infos)
          {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter278 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetCommentsForFeedRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.infos = new ArrayList<FeedCommentInfo>(_list279.size);
          for (int _i280 = 0; _i280 < _list279.size; ++_i280)
          {
            FeedCommentInfo _elem281; // required
            _elem281 = new FeedCommentInfo();
            _elem281.read(iprot);
            struct.infos.add(_elem281);
          }
        }
        struct.setInfosIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.params = new HashMap<String,String>(2*_map282.size);
          for (int _i283 = 0; _i283 < _map282.size; ++_i283)
          {
            ...
            struct.params.put(_key284, _val285);
          }
        }
        struct.setParamsIsSet(true);
      }
