...
public class GetFriendCommentsForFeedCountRequest implements org.apache.thrift.TBase<GetFriendCommentsForFeedCountRequest, GetFriendCommentsForFeedCountRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetFriendCommentsForFeedCountRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetFriendCommentsForFeedCountRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetFriendCommentsForFeedCountRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetFriendCommentsForFeedCountRequest.class, metaDataMap);
  }

  public GetFriendCommentsForFeedCountRequest() {
  }
   ...
   */
  public GetFriendCommentsForFeedCountRequest(GetFriendCommentsForFeedCountRequest other) {
  ...
  public GetFriendCommentsForFeedCountRequest deepCopy() {
    return new GetFriendCommentsForFeedCountRequest(this);
  }
   ...
   * 批量取首尾好友评论的参数
   */
  public GetFriendCommentsForFeedCountRequest setInfos(List<FeedCommentInfo> infos) {
    this.infos = infos;
    return this;
  }
   ...
   * 来校验权限
   */
  public GetFriendCommentsForFeedCountRequest setActorId(int actorId) {
  ...
  public GetFriendCommentsForFeedCountRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetFriendCommentsForFeedCountRequest)
      return this.equals((GetFriendCommentsForFeedCountRequest)that);
    return false;
  }

  public boolean equals(GetFriendCommentsForFeedCountRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetFriendCommentsForFeedCountRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetFriendCommentsForFeedCountRequest typedOther = (GetFriendCommentsForFeedCountRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetFriendCommentsForFeedCountRequest(");
    boolean first = true;
  ...
  private static class GetFriendCommentsForFeedCountRequestStandardSchemeFactory implements SchemeFactory {
    public GetFriendCommentsForFeedCountRequestStandardScheme getScheme() {
      return new GetFriendCommentsForFeedCountRequestStandardScheme();
    }
  }

  private static class GetFriendCommentsForFeedCountRequestStandardScheme extends StandardScheme<GetFriendCommentsForFeedCountRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetFriendCommentsForFeedCountRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.infos = new ArrayList<FeedCommentInfo>(_list352.size);
                for (int _i353 = 0; _i353 < _list352.size; ++_i353)
                {
                  FeedCommentInfo _elem354; // required
                  _elem354 = new FeedCommentInfo();
                  _elem354.read(iprot);
                  struct.infos.add(_elem354);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.params = new HashMap<String,String>(2*_map355.size);
                for (int _i356 = 0; _i356 < _map355.size; ++_i356)
                {
                  String _key357; // required
                  String _val358; // required
                  _key357 = iprot.readString();
                  _val358 = iprot.readString();
                  struct.params.put(_key357, _val358);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetFriendCommentsForFeedCountRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.infos != null) {
        oprot.writeFieldBegin(INFOS_FIELD_DESC);
        {
          ...
          for (FeedCommentInfo _iter359 : struct.infos)
          {
      ...
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter360 : struct.params.entrySet())
            {
  ...
  private static class GetFriendCommentsForFeedCountRequestTupleSchemeFactory implements SchemeFactory {
    public GetFriendCommentsForFeedCountRequestTupleScheme getScheme() {
      return new GetFriendCommentsForFeedCountRequestTupleScheme();
    }
  }

  private static class GetFriendCommentsForFeedCountRequestTupleScheme extends TupleScheme<GetFriendCommentsForFeedCountRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetFriendCommentsForFeedCountRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetInfos()) {
        {
          ...
          for (FeedCommentInfo _iter361 : struct.infos)
          {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter362 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetFriendCommentsForFeedCountRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.infos = new ArrayList<FeedCommentInfo>(_list363.size);
          for (int _i364 = 0; _i364 < _list363.size; ++_i364)
          {
            FeedCommentInfo _elem365; // required
            _elem365 = new FeedCommentInfo();
            _elem365.read(iprot);
            struct.infos.add(_elem365);
          }
        }
        struct.setInfosIsSet(true);
      }
