...
public class GetFriendsCommentListRequest implements org.apache.thrift.TBase<GetFriendsCommentListRequest, GetFriendsCommentListRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetFriendsCommentListRequest");
  ...
  private static final org.apache.thrift.protocol.TField DESC_FIELD_DESC = new org.apache.thrift.protocol.TField("desc", org.apache.thrift.protocol.TType.BOOL, (short)7);
  ...
  static {
    schemes.put(StandardScheme.class, new GetFriendsCommentListRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetFriendsCommentListRequestTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.OFFSET,_Fields.LIMIT,_Fields.DESC,_Fields.PARAMS};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetFriendsCommentListRequest.class, metaDataMap);
  }

  public GetFriendsCommentListRequest() {
  }
   ...
   */
  public GetFriendsCommentListRequest(GetFriendsCommentListRequest other) {
  ...
  public GetFriendsCommentListRequest deepCopy() {
    return new GetFriendsCommentListRequest(this);
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public GetFriendsCommentListRequest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 获取评论列表Id - 该字段对于获取好友评论是必须的
   */
  public GetFriendsCommentListRequest setActorId(int actorId) {
    this.actorId = actorId;
    setActorIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体Id
   */
  public GetFriendsCommentListRequest setEntryId(long entryId) {
    this.entryId = entryId;
    setEntryIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体所有者Id
   */
  public GetFriendsCommentListRequest setEntryOwnerId(int entryOwnerId) {
    this.entryOwnerId = entryOwnerId;
    setEntryOwnerIdIsSet(true);
    return this;
  }
   ...
   * 搜索开始的位置
   */
  public GetFriendsCommentListRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
   ...
   * 返回结果的最大个数
   */
  public GetFriendsCommentListRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
   ...
   * 返回结果排序，true为从最新到旧返回结果
   */
  public GetFriendsCommentListRequest setDesc(boolean desc) {
    this.desc = desc;
    setDescIsSet(true);
    return this;
  }
   ...
   * 额外的参数，用于传入业务相关的参数
   */
  public GetFriendsCommentListRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetFriendsCommentListRequest)
      return this.equals((GetFriendsCommentListRequest)that);
    return false;
  }

  public boolean equals(GetFriendsCommentListRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetFriendsCommentListRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetFriendsCommentListRequest typedOther = (GetFriendsCommentListRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetFriendsCommentListRequest(");
    boolean first = true;
  ...
  private static class GetFriendsCommentListRequestStandardSchemeFactory implements SchemeFactory {
    public GetFriendsCommentListRequestStandardScheme getScheme() {
      return new GetFriendsCommentListRequestStandardScheme();
    }
  }

  private static class GetFriendsCommentListRequestStandardScheme extends StandardScheme<GetFriendsCommentListRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetFriendsCommentListRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.params = new HashMap<String,String>(2*_map216.size);
                for (int _i217 = 0; _i217 < _map216.size; ++_i217)
                {
                  ...
                  struct.params.put(_key218, _val219);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetFriendsCommentListRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter220 : struct.params.entrySet())
            {
  ...
  private static class GetFriendsCommentListRequestTupleSchemeFactory implements SchemeFactory {
    public GetFriendsCommentListRequestTupleScheme getScheme() {
      return new GetFriendsCommentListRequestTupleScheme();
    }
  }

  private static class GetFriendsCommentListRequestTupleScheme extends TupleScheme<GetFriendsCommentListRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetFriendsCommentListRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter221 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetFriendsCommentListRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.params = new HashMap<String,String>(2*_map222.size);
          for (int _i223 = 0; _i223 < _map222.size; ++_i223)
          {
            ...
            struct.params.put(_key224, _val225);
          }
        }
        struct.setParamsIsSet(true);
      }
