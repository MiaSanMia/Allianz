...
public class IncreaseVoiceCommentPlayCountRequest implements org.apache.thrift.TBase<IncreaseVoiceCommentPlayCountRequest, IncreaseVoiceCommentPlayCountRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("IncreaseVoiceCommentPlayCountRequest");
  ...
  private static final org.apache.thrift.protocol.TField INCREMENT_FIELD_DESC = new org.apache.thrift.protocol.TField("increment", org.apache.thrift.protocol.TType.I32, (short)6);
  ...
  static {
    schemes.put(StandardScheme.class, new IncreaseVoiceCommentPlayCountRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new IncreaseVoiceCommentPlayCountRequestTupleSchemeFactory());
  }
  ...
  private static final int __INCREMENT_ISSET_ID = 4;
  private BitSet __isset_bit_vector = new BitSet(5);
  private _Fields optionals[] = {_Fields.ACTOR_ID,_Fields.INCREMENT,_Fields.PARAMS};
  ...
  static {
    ...
    tmpMap.put(_Fields.COMMENT_ID, new org.apache.thrift.meta_data.FieldMetaData("commentId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.INCREMENT, new org.apache.thrift.meta_data.FieldMetaData("increment", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(IncreaseVoiceCommentPlayCountRequest.class, metaDataMap);
  }

  public IncreaseVoiceCommentPlayCountRequest() {
    this.increment = 1;
   ...
   */
  public IncreaseVoiceCommentPlayCountRequest(IncreaseVoiceCommentPlayCountRequest other) {
  ...
  public IncreaseVoiceCommentPlayCountRequest deepCopy() {
    return new IncreaseVoiceCommentPlayCountRequest(this);
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public IncreaseVoiceCommentPlayCountRequest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 来校验权限
   */
  public IncreaseVoiceCommentPlayCountRequest setActorId(int actorId) {
   ...
   * 被评论实体Id
   */
  public IncreaseVoiceCommentPlayCountRequest setEntryId(long entryId) {
    this.entryId = entryId;
    setEntryIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体所有者Id
   */
  public IncreaseVoiceCommentPlayCountRequest setEntryOwnerId(int entryOwnerId) {
    this.entryOwnerId = entryOwnerId;
    setEntryOwnerIdIsSet(true);
    return this;
  }
   ...
   * 要增加播放次数的评论Id
   */
  public IncreaseVoiceCommentPlayCountRequest setCommentId(long commentId) {
    this.commentId = commentId;
    setCommentIdIsSet(true);
    return this;
  }
   ...
   * 要增加的播放的次数，如果不设，默认为1
   */
  public IncreaseVoiceCommentPlayCountRequest setIncrement(int increment) {
   ...
   * 额外的参数，用于传入业务相关的参数
   */
  public IncreaseVoiceCommentPlayCountRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof IncreaseVoiceCommentPlayCountRequest)
      return this.equals((IncreaseVoiceCommentPlayCountRequest)that);
    return false;
  }

  public boolean equals(IncreaseVoiceCommentPlayCountRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(IncreaseVoiceCommentPlayCountRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    IncreaseVoiceCommentPlayCountRequest typedOther = (IncreaseVoiceCommentPlayCountRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("IncreaseVoiceCommentPlayCountRequest(");
    boolean first = true;
  ...
  private static class IncreaseVoiceCommentPlayCountRequestStandardSchemeFactory implements SchemeFactory {
    public IncreaseVoiceCommentPlayCountRequestStandardScheme getScheme() {
      return new IncreaseVoiceCommentPlayCountRequestStandardScheme();
    }
  }

  private static class IncreaseVoiceCommentPlayCountRequestStandardScheme extends StandardScheme<IncreaseVoiceCommentPlayCountRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, IncreaseVoiceCommentPlayCountRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // INCREMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.increment = iprot.readI32();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.params = new HashMap<String,String>(2*_map162.size);
                for (int _i163 = 0; _i163 < _map162.size; ++_i163)
                {
                  ...
                  struct.params.put(_key164, _val165);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IncreaseVoiceCommentPlayCountRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetIncrement()) {
        ...
        oprot.writeI32(struct.increment);
        oprot.writeFieldEnd();
      }
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter166 : struct.params.entrySet())
            {
  ...
  private static class IncreaseVoiceCommentPlayCountRequestTupleSchemeFactory implements SchemeFactory {
    public IncreaseVoiceCommentPlayCountRequestTupleScheme getScheme() {
      return new IncreaseVoiceCommentPlayCountRequestTupleScheme();
    }
  }

  private static class IncreaseVoiceCommentPlayCountRequestTupleScheme extends TupleScheme<IncreaseVoiceCommentPlayCountRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, IncreaseVoiceCommentPlayCountRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter167 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, IncreaseVoiceCommentPlayCountRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.params = new HashMap<String,String>(2*_map168.size);
          for (int _i169 = 0; _i169 < _map168.size; ++_i169)
          {
            ...
            struct.params.put(_key170, _val171);
          }
        }
        struct.setParamsIsSet(true);
      }
