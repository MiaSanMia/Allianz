...
public class RecoverAllCommentResquest implements org.apache.thrift.TBase<RecoverAllCommentResquest, RecoverAllCommentResquest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RecoverAllCommentResquest");
  ...
  static {
    schemes.put(StandardScheme.class, new RecoverAllCommentResquestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RecoverAllCommentResquestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RecoverAllCommentResquest.class, metaDataMap);
  }

  public RecoverAllCommentResquest() {
  }
   ...
   */
  public RecoverAllCommentResquest(RecoverAllCommentResquest other) {
  ...
  public RecoverAllCommentResquest deepCopy() {
    return new RecoverAllCommentResquest(this);
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public RecoverAllCommentResquest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 恢复评论者用户id
   */
  public RecoverAllCommentResquest setActorId(int actorId) {
   ...
   * 被评论实体Id
   */
  public RecoverAllCommentResquest setEntryId(long entryId) {
    this.entryId = entryId;
    setEntryIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体所有者Id
   */
  public RecoverAllCommentResquest setEntryOwnerId(int entryOwnerId) {
    this.entryOwnerId = entryOwnerId;
    setEntryOwnerIdIsSet(true);
    return this;
  }
   ...
   * 额外的参数，用于传入业务相关的参数
   */
  public RecoverAllCommentResquest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RecoverAllCommentResquest)
      return this.equals((RecoverAllCommentResquest)that);
    return false;
  }

  public boolean equals(RecoverAllCommentResquest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RecoverAllCommentResquest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RecoverAllCommentResquest typedOther = (RecoverAllCommentResquest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RecoverAllCommentResquest(");
    boolean first = true;
  ...
  private static class RecoverAllCommentResquestStandardSchemeFactory implements SchemeFactory {
    public RecoverAllCommentResquestStandardScheme getScheme() {
      return new RecoverAllCommentResquestStandardScheme();
    }
  }

  private static class RecoverAllCommentResquestStandardScheme extends StandardScheme<RecoverAllCommentResquest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RecoverAllCommentResquest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.params = new HashMap<String,String>(2*_map142.size);
                for (int _i143 = 0; _i143 < _map142.size; ++_i143)
                {
                  ...
                  struct.params.put(_key144, _val145);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RecoverAllCommentResquest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter146 : struct.params.entrySet())
            {
  ...
  private static class RecoverAllCommentResquestTupleSchemeFactory implements SchemeFactory {
    public RecoverAllCommentResquestTupleScheme getScheme() {
      return new RecoverAllCommentResquestTupleScheme();
    }
  }

  private static class RecoverAllCommentResquestTupleScheme extends TupleScheme<RecoverAllCommentResquest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RecoverAllCommentResquest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter147 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RecoverAllCommentResquest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.params = new HashMap<String,String>(2*_map148.size);
          for (int _i149 = 0; _i149 < _map148.size; ++_i149)
          {
            ...
            struct.params.put(_key150, _val151);
          }
        }
        struct.setParamsIsSet(true);
      }
