...
public class RemoveAllCommentRequest implements org.apache.thrift.TBase<RemoveAllCommentRequest, RemoveAllCommentRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoveAllCommentRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new RemoveAllCommentRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RemoveAllCommentRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoveAllCommentRequest.class, metaDataMap);
  }

  public RemoveAllCommentRequest() {
  }
   ...
   */
  public RemoveAllCommentRequest(RemoveAllCommentRequest other) {
  ...
  public RemoveAllCommentRequest deepCopy() {
    return new RemoveAllCommentRequest(this);
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public RemoveAllCommentRequest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 删除评论者用户id
   */
  public RemoveAllCommentRequest setActorId(int actorId) {
   ...
   * 被评论实体Id
   */
  public RemoveAllCommentRequest setEntryId(long entryId) {
    this.entryId = entryId;
    setEntryIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体所有者Id
   */
  public RemoveAllCommentRequest setEntryOwnerId(int entryOwnerId) {
    this.entryOwnerId = entryOwnerId;
    setEntryOwnerIdIsSet(true);
    return this;
  }
   ...
   * 额外的参数，用于传入业务相关的参数
   */
  public RemoveAllCommentRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemoveAllCommentRequest)
      return this.equals((RemoveAllCommentRequest)that);
    return false;
  }

  public boolean equals(RemoveAllCommentRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RemoveAllCommentRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RemoveAllCommentRequest typedOther = (RemoveAllCommentRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RemoveAllCommentRequest(");
    boolean first = true;
  ...
  private static class RemoveAllCommentRequestStandardSchemeFactory implements SchemeFactory {
    public RemoveAllCommentRequestStandardScheme getScheme() {
      return new RemoveAllCommentRequestStandardScheme();
    }
  }

  private static class RemoveAllCommentRequestStandardScheme extends StandardScheme<RemoveAllCommentRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoveAllCommentRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoveAllCommentRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter126 : struct.params.entrySet())
            {
  ...
  private static class RemoveAllCommentRequestTupleSchemeFactory implements SchemeFactory {
    public RemoveAllCommentRequestTupleScheme getScheme() {
      return new RemoveAllCommentRequestTupleScheme();
    }
  }

  private static class RemoveAllCommentRequestTupleScheme extends TupleScheme<RemoveAllCommentRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RemoveAllCommentRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter127 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RemoveAllCommentRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.params = new HashMap<String,String>(2*_map128.size);
          for (int _i129 = 0; _i129 < _map128.size; ++_i129)
          {
            ...
            struct.params.put(_key130, _val131);
          }
        }
        struct.setParamsIsSet(true);
      }
