...
public class RemoveCommentRequest implements org.apache.thrift.TBase<RemoveCommentRequest, RemoveCommentRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoveCommentRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new RemoveCommentRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RemoveCommentRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoveCommentRequest.class, metaDataMap);
  }
   ...
   */
  public RemoveCommentRequest(RemoveCommentRequest other) {
  ...
  public RemoveCommentRequest deepCopy() {
    return new RemoveCommentRequest(this);
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public RemoveCommentRequest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 来校验权限
   */
  public RemoveCommentRequest setActorId(int actorId) {
   ...
   * 被评论实体Id
   */
  public RemoveCommentRequest setEntryId(long entryId) {
    this.entryId = entryId;
    setEntryIdIsSet(true);
    return this;
  }
   ...
   * 被评论实体所有者Id
   */
  public RemoveCommentRequest setEntryOwnerId(int entryOwnerId) {
    this.entryOwnerId = entryOwnerId;
    setEntryOwnerIdIsSet(true);
    return this;
  }
   ...
   * 要删除的评论Id
   */
  public RemoveCommentRequest setCommentId(long commentId) {
    this.commentId = commentId;
    setCommentIdIsSet(true);
    return this;
  }
   ...
   * 额外的参数，用于传入业务相关的参数
   */
  public RemoveCommentRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemoveCommentRequest)
      return this.equals((RemoveCommentRequest)that);
    return false;
  }

  public boolean equals(RemoveCommentRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RemoveCommentRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RemoveCommentRequest typedOther = (RemoveCommentRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RemoveCommentRequest(");
    boolean first = true;
  ...
  private static class RemoveCommentRequestStandardSchemeFactory implements SchemeFactory {
    public RemoveCommentRequestStandardScheme getScheme() {
      return new RemoveCommentRequestStandardScheme();
    }
  }

  private static class RemoveCommentRequestStandardScheme extends StandardScheme<RemoveCommentRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoveCommentRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoveCommentRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter106 : struct.params.entrySet())
            {
  ...
  private static class RemoveCommentRequestTupleSchemeFactory implements SchemeFactory {
    public RemoveCommentRequestTupleScheme getScheme() {
      return new RemoveCommentRequestTupleScheme();
    }
  }

  private static class RemoveCommentRequestTupleScheme extends TupleScheme<RemoveCommentRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RemoveCommentRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter107 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RemoveCommentRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.params = new HashMap<String,String>(2*_map108.size);
          for (int _i109 = 0; _i109 < _map108.size; ++_i109)
          {
            ...
            struct.params.put(_key110, _val111);
          }
        }
        struct.setParamsIsSet(true);
      }
