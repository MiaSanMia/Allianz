...
public class RemoveGlobalCommentRequest implements org.apache.thrift.TBase<RemoveGlobalCommentRequest, RemoveGlobalCommentRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoveGlobalCommentRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new RemoveGlobalCommentRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RemoveGlobalCommentRequestTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.ACTOR_ID,_Fields.ENTRY_ID,_Fields.ENTRY_OWNER_ID,_Fields.PARAMS};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoveGlobalCommentRequest.class, metaDataMap);
  }

  public RemoveGlobalCommentRequest() {
  }
   ...
   */
  public RemoveGlobalCommentRequest(RemoveGlobalCommentRequest other) {
  ...
  public RemoveGlobalCommentRequest deepCopy() {
    return new RemoveGlobalCommentRequest(this);
  }
   ...
   * @see com.renren.ugc.comment.xoa2.CommentType
   */
  public RemoveGlobalCommentRequest setType(com.renren.ugc.comment.xoa2.CommentType type) {
    this.type = type;
    return this;
  }
   ...
   * 删除评论者用户id
   */
  public RemoveGlobalCommentRequest setActorId(int actorId) {
   ...
   * 被评论实体Id
   */
  public RemoveGlobalCommentRequest setEntryId(long entryId) {
   ...
   * 被评论实体所有者Id
   */
  public RemoveGlobalCommentRequest setEntryOwnerId(int entryOwnerId) {
   ...
   * 要删除的评论Id
   */
  public RemoveGlobalCommentRequest setCommentId(long commentId) {
    this.commentId = commentId;
    setCommentIdIsSet(true);
    return this;
  }
   ...
   * 额外的参数，用于传入业务相关的参数
   */
  public RemoveGlobalCommentRequest setParams(Map<String,String> params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemoveGlobalCommentRequest)
      return this.equals((RemoveGlobalCommentRequest)that);
    return false;
  }

  public boolean equals(RemoveGlobalCommentRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RemoveGlobalCommentRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RemoveGlobalCommentRequest typedOther = (RemoveGlobalCommentRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RemoveGlobalCommentRequest(");
    boolean first = true;
  ...
  private static class RemoveGlobalCommentRequestStandardSchemeFactory implements SchemeFactory {
    public RemoveGlobalCommentRequestStandardScheme getScheme() {
      return new RemoveGlobalCommentRequestStandardScheme();
    }
  }

  private static class RemoveGlobalCommentRequestStandardScheme extends StandardScheme<RemoveGlobalCommentRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoveGlobalCommentRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.params = new HashMap<String,String>(2*_map112.size);
                for (int _i113 = 0; _i113 < _map112.size; ++_i113)
                {
                  ...
                  struct.params.put(_key114, _val115);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoveGlobalCommentRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.params != null) {
        if (struct.isSetParams()) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter116 : struct.params.entrySet())
            {
  ...
  private static class RemoveGlobalCommentRequestTupleSchemeFactory implements SchemeFactory {
    public RemoveGlobalCommentRequestTupleScheme getScheme() {
      return new RemoveGlobalCommentRequestTupleScheme();
    }
  }

  private static class RemoveGlobalCommentRequestTupleScheme extends TupleScheme<RemoveGlobalCommentRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RemoveGlobalCommentRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter117 : struct.params.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RemoveGlobalCommentRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.params = new HashMap<String,String>(2*_map118.size);
          for (int _i119 = 0; _i119 < _map118.size; ++_i119)
          {
            ...
            struct.params.put(_key120, _val121);
          }
        }
        struct.setParamsIsSet(true);
      }
