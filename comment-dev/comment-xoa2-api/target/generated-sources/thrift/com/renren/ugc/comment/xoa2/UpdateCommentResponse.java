...
public class UpdateCommentResponse implements org.apache.thrift.TBase<UpdateCommentResponse, UpdateCommentResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UpdateCommentResponse");

  private static final org.apache.thrift.protocol.TField UPDATED_FIELD_DESC = new org.apache.thrift.protocol.TField("updated", org.apache.thrift.protocol.TType.BOOL, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new UpdateCommentResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UpdateCommentResponseTupleSchemeFactory());
  }

  /**
   * 是否已经更新
   */
  public boolean updated; // optional
  /**
   * 响应信息
   */
  ...
  private _Fields optionals[] = {_Fields.UPDATED,_Fields.BASE_REP};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UpdateCommentResponse.class, metaDataMap);
  }
   ...
   */
  public UpdateCommentResponse(UpdateCommentResponse other) {
  ...
  public UpdateCommentResponse deepCopy() {
   ...
   * 是否已经更新
   */
  public UpdateCommentResponse setUpdated(boolean updated) {
   ...
   * 响应信息
   */
  public UpdateCommentResponse setBaseRep(com.renren.xoa2.BaseResponse baseRep) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UpdateCommentResponse)
      return this.equals((UpdateCommentResponse)that);
    return false;
  }

  public boolean equals(UpdateCommentResponse that) {
    if (that == null)
      return false;
  ...
  public int hashCode() {
    ...
    builder.append(present_updated);
    if (present_updated)
  ...
  public int compareTo(UpdateCommentResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    UpdateCommentResponse typedOther = (UpdateCommentResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UpdateCommentResponse(");
    boolean first = true;
  ...
  private static class UpdateCommentResponseStandardSchemeFactory implements SchemeFactory {
    public UpdateCommentResponseStandardScheme getScheme() {
      return new UpdateCommentResponseStandardScheme();
    }
  }

  private static class UpdateCommentResponseStandardScheme extends StandardScheme<UpdateCommentResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UpdateCommentResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateCommentResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class UpdateCommentResponseTupleSchemeFactory implements SchemeFactory {
    public UpdateCommentResponseTupleScheme getScheme() {
      return new UpdateCommentResponseTupleScheme();
    }
  }

  private static class UpdateCommentResponseTupleScheme extends TupleScheme<UpdateCommentResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UpdateCommentResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateCommentResponse struct) throws org.apache.thrift.TException {
