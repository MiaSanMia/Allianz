...
public class BaseResponse implements org.apache.thrift.TBase<BaseResponse, BaseResponse._Fields>, java.io.Serializable, Cloneable {
  ...
  public ErrorInfo errorInfo; // optional
  ...
  private _Fields optionals[] = {_Fields.ERROR_INFO};
  ...
  public BaseResponse(BaseResponse other) {
    if (other.isSetErrorInfo()) {
      this.errorInfo = new ErrorInfo(other.errorInfo);
    }
  }
  ...
  public BaseResponse setErrorInfo(ErrorInfo errorInfo) {
  ...
  public int hashCode() {
    ...
    builder.append(present_errorInfo);
        ...
        switch (schemeField.id) {
          case 1: // ERROR_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.errorInfo = new ErrorInfo();
